/*! react-auth-kit v2.12.3 | Apache-2.0 */
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */S.defaultProps={cookieDomain:window.location.hostname,cookieSecure:"https:"===window.location.protocol},e.AuthProvider=S,e.RequireAuth=function(e){var t=e.children,r=e.loginPath,o=i.useContext(a);if(null===o)throw new p("Auth Provider is missing. Please add the AuthProvider before Router");var s=n.useLocation();return T(o.authState)?t:(o.dispatch(k()),i.createElement(n.Navigate,{to:r,state:{from:s},replace:!0}))},e.createRefresh=function(e){return e},e.useAuthHeader=
/**
     * @author Arkadip Bhattacharya <in2arkadipb13@gmail.com>
     ...
     * limitations under the License.
     */
function(){var e=i.useContext(a);if(null===e)throw new p("Auth Provider is missing. Please add the AuthProvider before Router");return function(){return e.authState.auth&&T(e.authState)?"".concat(e.authState.auth.type," ").concat(e.authState.auth.token):""}}
/**
     * @author Arkadip Bhattacharya <in2arkadipb13@gmail.com>
...
/**
     ...
     * limitations under the License.
     */
function(e){return function(t){return i.createElement(s,null,(function(r){if(null===r)throw new p("Auth Provider is missing. Please add the AuthProvider before Router");return r.authState.auth&&T(r.authState)?i.createElement(e,c({},t,{authHeader:"".concat(r.authState.auth.type," ").concat(r.authState.auth.token)})):i.createElement(e,c({},t,{authHeader:""}))}))}}
/**
     * @author Arkadip Bhattacharya <in2arkadipb13@gmail.com>
